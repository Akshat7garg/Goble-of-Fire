...
Goblet of Fire
Goblet of Fire is an online multiplayer platform featuring Ludo, Chess, Snakes and Ladders, Sudoku, and Snake Feeder, including Next.js, TypeScript, Tailwind CSS, MongoDB, Prisma, and NextAuth. It features real-time chatting, group creation, profile customization, online status tracking, image uploads, and various authentication methods, including email and social logins with Github, Google, and Twitter. This README will provide comprehensive documentation for setting up, running, and customizing the application.

## Features

- **Real-Time Chatting**: Enjoy real-time chat with other users.
- **Group Creation**: Create Gameplay for multiple users.
...
Follow these steps to set up the Goblet of Fire
Goblet of Fire locally:

1. Clone the repository

```bash
git clone https://github.com/Akshat7garg/Goblet of Fire.git
cd Goblet of Fire
```
